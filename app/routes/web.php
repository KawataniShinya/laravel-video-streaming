...
Route::middleware('auth')->group(function () {
    ...
    Route::get('/history', [VideoController::class, 'history'])->name('videos.history');
    ...
    Route::get('/admin/hls-cache/size/{hash}', [HlsCacheController::class, 'getSize'])->name('admin.hls.size');
